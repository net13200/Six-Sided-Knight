...
| --------------- | -------------------------------- | ----------------------- |
| Roll            | Swipe, or tap toward a tile      | Arrow keys or WASD      |
| Undo / Retry    | Buttons under the board          | Z (or U, Backspace) / R |
| Inspect the die | Tap the die or the compass       | I                       |
...
| Face   | Leading (rolled into something)                                                 | Elsewhere                                       |
| ------ | ------------------------------------------------------------------------------- | ----------------------------------------------- |
| Sword  | 3 damage                                                                        |                                                 |
...
- **Skeleton** (2 HP): chases you every turn and hits for 1.
- **Slime** (3 HP): moves every other turn; the badge shows "!" when it's about to act.
